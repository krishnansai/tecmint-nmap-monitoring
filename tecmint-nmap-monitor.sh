...
echo It\'s your ip to scan $internalip

echo " "
echo -e '\E[32m'" open ports in your server is : " $tecreset
nmap -vvv $internalip | grep "Scanning" | awk  '{ print $3 }'

nmap -vvv $internalip | awk '/open/{print $1 " "$2" " $3 "\n"}'
...
SLACK_WEBHOOK="https://hooks.slack.com/services/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"
